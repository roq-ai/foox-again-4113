  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - Your ultimate marketplace bridging the gap between freelancers and companies offering jobs. Discover opportunities, build connections, shape your career."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - Your ultimate marketplace bridging the gap between freelancers and companies offering jobs. Discover opportunities, build connections, shape your career.`}
            </Text>
            <Box
